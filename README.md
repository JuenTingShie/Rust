...
-   - [x]  [**4.1.** 變數綁定](http://askeing.github.io/rust-book/variable-bindings.html)
    ...
    - [x]  [**4.6.** 迴圈](http://askeing.github.io/rust-book/loops.html)
    - [x]  [**4.7.** 所有權](http://askeing.github.io/rust-book/ownership.html)
    - [x]  [**4.8.** 參照與借用](http://askeing.github.io/rust-book/references-and-borrowing.html)
    - [x]  [**4.9.** 生命週期](http://askeing.github.io/rust-book/lifetimes.html)
